  ...
  import { Eye, EyeOff, BookOpen, User, Lock, Mail, LogIn, ArrowLeft } from 'lucide-react';
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-8 bg-[#f4efe8]">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8 border border-[#8c1c13]/20">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-[#472425]">Giriş Yap</h1>
              <p className="text-[#5f4b44] mt-2 text-center">Kütüphane sistemine giriş yapmak için bilgilerinizi giriniz</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex justify-end mt-1">
                <button className="text-[#8c1c13] text-sm hover:text-[#630000]">
                  Şifremi Unuttum
                </button>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-[#5f4b44]">
                Hesabınız yok mu?{" "}
                <Link to="/register" className="text-[#8c1c13] hover:text-[#630000] font-medium">
                  Hesap Oluştur
                </Link>
              </p>
            </div>
