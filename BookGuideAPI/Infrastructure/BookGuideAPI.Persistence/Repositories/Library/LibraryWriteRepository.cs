...
{
    public class LibraryWriteRepository : WriteRepository<Library>, ILibraryWriteRepository
    {
        public LibraryWriteRepository(BookGuideDbContext context) : base(context)
        {
        }
    }
}
